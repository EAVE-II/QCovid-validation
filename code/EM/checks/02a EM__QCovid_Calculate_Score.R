...
#read in data and modify endpoints. 
...
#  slice_sample(df, n=10) %>% 
  ...
  mutate(ethrisk= case_when(Q_ETHNICITY_1 == 1 | Q_ETHNICITY_2 == 1 | Q_ETHNICITY_3 == 1 | Q_ETHNICITY_4 == 1 ~ 2,  # White
                            Q_ETHNICITY_5 == 1 | Q_ETHNICITY_6 == 1 | Q_ETHNICITY_7 == 1  ~ 2,  # White #deleted indian from this group
                            ...
                            Q_ETHNICITY_16 == 1 | Q_ETHNICITY_14 == 1  ~ 10, #other - deleted 15, added 16 (other eth) and 14 (other black)
