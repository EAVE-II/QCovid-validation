...
saveRDS(z.fit.M.H, paste0(Location, "EAVE/GPanalysis/QCovid_Validation/output/CR_Model_Hosp_Male.rds"))
...
summary(z.fit.M.D)
saveRDS(z.fit.M.D, paste0(Location, "EAVE/GPanalysis/QCovid_Validation/output/CR_Model_Death_Male.rds"))
termplot(z.fit.F.D, term=1, se=TRUE, col.term=1, col.se=1)
termplot(z.fit.F.D, term=2, se=TRUE, col.term=1, col.se=1)
termplot(z.fit.F.D, term=3, se=TRUE, col.term=1, col.se=1)
