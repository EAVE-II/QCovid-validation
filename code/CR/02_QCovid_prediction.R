...
death_female <- function(x){
  ...
  # a is used in calculating score.
   ...
   a <- a + (coef %*% x[10:40] ) -0.0200621605517602719093162 * age_1 * x[37] + 0.0074957790032429043661222 * age_2 * x[37]
...
hospital_female <- function(x){
  ...
  a <- a + (coef %*% x[10:40] ) - 1.1514860942738034399468461 * age_1 * x[37] + 0.0018396028070442396740169 * age_2 * x[37]
...
death_male <- function(x){
  ...
  a <- a + (coef %*% x[10:40] ) - 0.5325370730252168005591784 * age_1 * x[37] + 0.0013434948852218797209906 * age_2 * x[37]
...
hospital_male <- function(x){
  ...
  a <- a + (coef %*% x[10:40] ) + 8.1824740477927431214766330 * age_1 * x[37] - 0.0088155777714664287220137 * age_2 * x[37]
