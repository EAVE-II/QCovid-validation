...
z.fit.M.D <- readRDS("/conf/EAVE/GPanalysis/QCovid_Validation/output/EM_Model_Death_Male.rds")##males use my reruns.
z.fit.F.D <- readRDS("/conf/EAVE/GPanalysis/QCovid_Validation/output/CR_Model_Death_Female.rds")
z.fit.M.H <- readRDS("/conf/EAVE/GPanalysis/QCovid_Validation/output/EM_Model_Hosp_Male.rds")
z.fit.F.H <- readRDS("/conf/EAVE/GPanalysis/QCovid_Validation/output/CR_Model_Hosp_Female.rds")
```
Description of modelling....

A cox model was fitted using the risk facotrs for hospitalisaiton and death identified by QCOVID. With the exception that data for chemotherapy, radiotherapy and trtansplants wer not avalible 

#### Females, deaths
```{r splineplots FD, echo=FALSE}
ptemp <- readRDS( "/conf/EAVE/GPanalysis/QCovid_Validation/output/temp/ptemp_F_D.rds")
...
ptemp <- readRDS( "/conf/EAVE/GPanalysis/QCovid_Validation/output/temp/ptemp_M_D.rds")
...
ptemp <- readRDS( "/conf/EAVE/GPanalysis/QCovid_Validation/output/temp/ptemp_F_H.rds")
...
splineplot(ptemp, "Age", centre = 20 , title = "Females hospitalisation risk by -  Age")
...
ptemp <- readRDS( "/conf/EAVE/GPanalysis/QCovid_Validation/output/temp/ptemp_M_H.rds")
...
splineplot(ptemp, "Age", centre = 20 , title = "Males hospitalisation risk by -  Age")
